...
def create_ui(config, theme_name="Ocean"):
    ...
    with gr.Blocks(
            title="Web Use - BytArch", theme=theme_map[theme_name], css=css
    ) as demo:
        with gr.Row():
            gr.Markdown(
                """
        ...
        with gr.Tabs() as tabs:
            with gr.TabItem("⚙️ Agent Settings", id=1):
                with gr.Group():
                    ...
                    with gr.Group():
                        ...
                        llm_model_name = gr.Dropdown(
                            label="Model Name",
                            choices=utils.model_names['bytarch'],
                    ...
                    with gr.Column():
                        use_vision = gr.Checkbox(
                            ...
                            info="Enable visual processing capabilities (currently only available through '501::browser-use' model)",
                        )
                ...
                with gr.Row():
                    browser_view = gr.HTML(
                        value="<h1 style='width:80vw; height:50vh'>Press Run Agent to start...</h1>",
            ...
            with gr.TabItem("📊 Results", visible=True, id=6):
                with gr.Group():

                    recording_display = gr.Video(label="Latest Recording",visible=False)
            ...
            with gr.TabItem("📁 Configuration",visible=False, id=8):
                with gr.Group():
...
def main():
    ...
    demo.launch(
        ...
        allowed_paths=[current_directory]
    )
